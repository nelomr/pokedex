...
const selectedPokemon = ref<PokemonCardItem | null>(null);

function handleCardSelect(item: PokemonCardItem): void {
...
<template>
  <div id="app" class="min-h-screen bg-slate-900 text-slate-50">
    <div
      ...
      :inert="selectedPokemon !== null ? true : undefined"
    >
      ...
      >
        <PokemonGrid :items="store.paginatedItems" @select="handleCardSelect" />
        <PaginationControls
